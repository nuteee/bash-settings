...
alias ltr='ls -FGlAhptr'                    # Preferred 'ls -ltr impl'
...
# get_weather() {
#     eval curl -s wttr.in/Budapest?format=1
# }
...
# PROMPT_COMMAND='run_on_prompt_command;__git_ps1 "\u@\h:\w" "\\\$ "'

# PS1="\[\033[m\]|\[\033[1;35m\]\t\[\033[m\]|\[\e[1;31m\]\u\[\e[1;36m\]\[\033[m\]@\[\e[1;36m\]\h\[\033[m\]:\[\e[0m\]\[\e[1;32m\][\w]$(__git_ps1 " (%s)")\n> \[\e[0m\]"
...
LP_PS1_POSTFIX="\[\e[1;32m\]\n> \[\e[0m\]"
[[ $- = *i* ]] && source ~/liquidprompt/liquidprompt

alias weather='curl v2.wttr.in/Budapest -m 2'
#THIS MUST BE AT THE END OF THE FILE FOR SDKMAN TO WORK!!!
export SDKMAN_DIR="/Users/gbalkus/.sdkman"
[[ -s "/Users/gbalkus/.sdkman/bin/sdkman-init.sh" ]] && source "/Users/gbalkus/.sdkman/bin/sdkman-init.sh"
